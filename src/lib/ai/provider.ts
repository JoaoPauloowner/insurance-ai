...
export class MockAIProvider implements AIProvider {
  ...
  async qualifyInsuranceLead(history: { role: 'user' | 'assistant'; content: string }[]): Promise<LeadQualificationOutput> {
    ...
    // Detecção simplificada simulada para testes
    ...
    const output: LeadQualificationOutput = {
      ...
      sugestao_resposta_ao_cliente: `Olá! Recebi as informações sobre o seu seguro ${tipoSeguro}. Nosso corretor especialista já está preparando o estudo de mercado e entrará em contato em breve com as propostas oficiais.`,
